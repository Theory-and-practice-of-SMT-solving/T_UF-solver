...
(assert (not (= y$n0s8 y$n7s8)))
(assert (not (= y$n1s8 y$n7s8)))
(assert (not (= y$n0s16 y$n3s16)))
(assert (not (= y$n0s16 y$n63s16)))
(assert (not (= y$n0s16 y$n64s16)))
(assert (not (= y$n3s16 y$n63s16)))
(assert (not (= y$n3s16 y$n64s16)))
(assert (not (= y$n63s16 y$n64s16)))
(assert (not (= y$n16s32 y$n1s32)))
(assert (not (= y$n16s32 y$n0s32)))
(assert (not (= y$n16s32 y$n4s32)))
(assert (not (= y$n16s32 y$n2s32)))
(assert (not (= y$n16s32 y$n63s32)))
(assert (not (= y$n16s32 y$n5s32)))
(assert (not (= y$n16s32 y$n7s32)))
(assert (not (= y$n16s32 y$n6s32)))
(assert (not (= y$n1s32 y$n0s32)))
(assert (not (= y$n1s32 y$n4s32)))
(assert (not (= y$n1s32 y$n2s32)))
(assert (not (= y$n1s32 y$n63s32)))
(assert (not (= y$n1s32 y$n5s32)))
(assert (not (= y$n1s32 y$n7s32)))
(assert (not (= y$n1s32 y$n6s32)))
(assert (not (= y$n0s32 y$n4s32)))
(assert (not (= y$n0s32 y$n2s32)))
(assert (not (= y$n0s32 y$n63s32)))
(assert (not (= y$n0s32 y$n5s32)))
(assert (not (= y$n0s32 y$n7s32)))
(assert (not (= y$n0s32 y$n6s32)))
(assert (not (= y$n4s32 y$n2s32)))
(assert (not (= y$n4s32 y$n63s32)))
(assert (not (= y$n4s32 y$n5s32)))
(assert (not (= y$n4s32 y$n7s32)))
(assert (not (= y$n4s32 y$n6s32)))
(assert (not (= y$n2s32 y$n63s32)))
(assert (not (= y$n2s32 y$n5s32)))
(assert (not (= y$n2s32 y$n7s32)))
(assert (not (= y$n2s32 y$n6s32)))
(assert (not (= y$n63s32 y$n5s32)))
(assert (not (= y$n63s32 y$n7s32)))
(assert (not (= y$n63s32 y$n6s32)))
(assert (not (= y$n5s32 y$n7s32)))
(assert (not (= y$n5s32 y$n6s32)))
(assert (not (= y$n7s32 y$n6s32)))

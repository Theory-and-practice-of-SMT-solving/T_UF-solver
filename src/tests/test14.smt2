...
(assert (not (= y$n1s7 y$n0s7)))
(assert (not (= y$n1s7 y$n8s7)))
(assert (not (= y$n1s7 y$n16s7)))
(assert (not (= y$n1s7 y$n32s7)))
(assert (not (= y$n1s7 y$n64s7)))
(assert (not (= y$n1s7 y$n2s7)))
(assert (not (= y$n1s7 y$n4s7)))
(assert (not (= y$n0s7 y$n8s7)))
(assert (not (= y$n0s7 y$n16s7)))
(assert (not (= y$n0s7 y$n32s7)))
(assert (not (= y$n0s7 y$n64s7)))
(assert (not (= y$n0s7 y$n2s7)))
(assert (not (= y$n0s7 y$n4s7)))
(assert (not (= y$n8s7 y$n16s7)))
(assert (not (= y$n8s7 y$n32s7)))
(assert (not (= y$n8s7 y$n64s7)))
(assert (not (= y$n8s7 y$n2s7)))
(assert (not (= y$n8s7 y$n4s7)))
(assert (not (= y$n16s7 y$n32s7)))
(assert (not (= y$n16s7 y$n64s7)))
(assert (not (= y$n16s7 y$n2s7)))
(assert (not (= y$n16s7 y$n4s7)))
(assert (not (= y$n32s7 y$n64s7)))
(assert (not (= y$n32s7 y$n2s7)))
(assert (not (= y$n32s7 y$n4s7)))
(assert (not (= y$n64s7 y$n2s7)))
(assert (not (= y$n64s7 y$n4s7)))
(assert (not (= y$n2s7 y$n4s7)))
...
(assert (= (and y$498 y$504 y$506 y$502 y$496) y$589))
...
(assert (= y$595 (and y$prop y$385 y$prop$next y$479 y$590)))
(assert y$595)
(assert (= (not (= y$n8s7 y$miss_state.miss_state_output$next)) y$553))
(assert (= (not (= y$n1s7 y$miss_state.miss_state_output$next)) y$550))
(assert (= (not (= y$n4s7 y$miss_state.miss_state_output$next)) y$552))
(assert (= (not (= y$n2s7 y$miss_state.miss_state_output$next)) y$551))
(assert (= (not (= y$n64s7 y$miss_state.miss_state_output$next)) y$556))
(assert (= y$592 (and y$550 y$551 y$552 y$553 y$556)))
(assert y$592)
